<template>
    <section id="faq" class="faq__section section">
        <div class="faq__section__container container">
            <div class="faq__section__header">
...
const faqCategories = computed(() => [
    ...
    {
        icon: 'carlos-icon:graphic-design',
